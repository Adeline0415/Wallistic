    ...
    return (
        <View style = {[styles.background,isDarkMode ? GlobalStyle.Surface_dark : GlobalStyle.Surface_light]}> 
            ...
            <Image source={require('../../assets/img/wallistic_semibold.png')}  
                style={styles.title}/>
            <View>
                <Image  style = {styles.image}source={require('../../assets/Logging/tutorial3.png')}></Image>
            </View>
            <View style = {styles.textbox}>
                <Text style = {[styles.text,isDarkMode?GlobalStyle.Surface_dark_font:GlobalStyle.Surface_light_font]}> The main page previews all the photos you have saved. Swipe left and right to view. Tap on folders to check out images you saved based on different categories.</Text>
            </View>
