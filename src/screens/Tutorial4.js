    ...
    return (
        <View style = {[styles.background,isDarkMode ? GlobalStyle.Surface_dark : GlobalStyle.Surface_light]}> 
            ...
            <Image source={require('../../assets/img/wallistic_semibold.png')}  
                style={styles.title}/>
            <View>
                <Image  style = {styles.image}source={require('../../assets/Logging/tutorial4.png')}></Image>
            </View>
            <View style = {styles.textbox}>
                <Text style = {[styles.text,isDarkMode?GlobalStyle.Surface_dark_font:GlobalStyle.Surface_light_font]}> Select a folder. Tap mode button to switch between lock screen, home screen, and normal modes.</Text>
            </View>
